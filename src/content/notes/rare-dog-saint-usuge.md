---
title: "The Rare Dog That Looks for Peents"
description: "A French spaniel saved from extinction, bred for woodcock, and how a line of them ended up in my family. What I've learned about birding with a dog in New York City."
pubDate: 2026-05-15
draft: false
author: "Shelly Xiong"
category: "Ethics"
...
topics:
  ...
  - woodcocks
  - NYC Off-Leash
ogImage: /images/notes/rare-dog-saint-usuge/coral-portrait.jpg
ogImageAlt: "Close-up portrait of Coral, an Épagneul de Saint-Usuge, with chestnut-pied head and heavily feathered ears, eyes alert and tongue just visible."
photoCredits: "All photographs by Shelly Xiong. Coral portraits in Bryant Park; American Woodcock in Bryant Park, spring 2026."
birdsMentioned:
  ...
  - commonName: "Veery"
    ebirdCode: "veery"
subwayRoutes:
  - hotspot: "Bryant Park (American Woodcock spring migration stopover)"
    lines: ["B", "D", "F", "M", "7"]
    directions: "B, D, F, or M to 42 St-Bryant Park, or 7 to 5 Av. Walk slowly along the shaded edges in late March and April. The woodcocks favor leaf litter under the azaleas."
  - hotspot: "Central Park, the Ramble (Ovenbird and Veery breeding habitat)"
    lines: ["B", "C", "1", "6"]
    directions: "B or C to 72 St or 81 St-Museum of Natural History, then walk east into the park. The 9 p.m. to 9 a.m. off-leash window applies elsewhere; the Ramble itself is leash-on for ground-nesting species through May and June."
  - hotspot: "Prospect Park, the Midwood (Ovenbird, Veery, ground-nesting migrants)"
    lines: ["2", "3", "F", "G", "B", "Q"]
    directions: "F or G to 15 St-Prospect Park for the south end, 2 or 3 to Grand Army Plaza for the north entrance. The Midwood interior is closed-canopy forest where ground nesters drop in to breed; leash-on through summer."
  - hotspot: "Breezy Point / Rockaway (Piping Plover nesting)"
    lines: ["A"]
    buses: ["Q22"]
    directions: "A train to Rockaway Park-Beach 116 St, then Q22 west toward Riis Park / Breezy Point. Closure signs are posted at the dunes April through August. Dogs are not permitted in the nesting areas even when leashed."
references:
  - author: "Club de l'Épagneul de Saint-Usuge"
    title: "Histoire"
    publication: "Official Club history page"
    url: "http://www.epagneuldesaintusuge.org/lesaintusuge/histoire/saintusuge.html"
  - author: "Adeline Guillemaut"
    title: "Coup d'oeil sur : l'Epagneul de Saint-Usuge"
    publication: "Écho Bressan"
    date: "April 2022"
    url: "https://www.echobressan.com/lepagneul-de-saint-usuge/"
  - author: "Société Centrale Canine"
    title: "Épagneul de saint usuge"
    publication: "Breed entry, French national kennel club"
    url: "https://www.centrale-canine.fr/le-chien-de-race/epagneul-de-saint-usuge"
  - author: "Jean-Pierre Duverne"
    title: "Chroniques de l'épagneul de Saint-Usuge : le chien, le club, les hommes et la cynophilie"
    publication: "Jean-Pierre Duverne, Le Creusot"
    date: "2020"
    note: "348 pp. ISBN 979-10-699-4630-9"
    url: "https://catalogue.bnf.fr/ark:/12148/cb46579373t"
  - author: "Scott R. Loss, Tom Will, and Peter P. Marra"
    title: "The impact of free-ranging domestic cats on wildlife of the United States"
    publication: "Nature Communications 4, 1396"
    date: "2013"
    url: "https://www.nature.com/articles/ncomms2380"
  - author: "Diocèse d'Autun"
    title: "Visage : BILLARD Robert"
    publication: "Visages du Diocèse d'Autun (Saône-et-Loire), biographical record"
    url: "https://www.visages-diocese-autun.fr/visage/billard-robert/"
...
The Épagneul de Saint-Usuge was bred to hunt woodcock. Specifically *Scolopax rusticola*, the [Eurasian Woodcock](https://ebird.org/species/eurwoo). A plump, cryptic, long-billed shorebird that forages in leaf litter, migrates at night, performs a dusk display flight on its breeding ground, and is exactly the kind of quarry a pointing spaniel is built for. Billard's breeding notebook recorded each dog's woodcock qualities above all others.

The [American Woodcock](https://ebird.org/species/amewoo), *Scolopax minor*, is the same genus. Same body plan. Same cryptic plumage. Same leaf-litter probing. Same role at dusk on the breeding ground. But the Eurasian is bigger. The Eurasian doesn't peent. Its display, called *roding*, is a slow patrol above the treetops at dusk, with a sequence of low grunts and a high pist note. The American calls its peent from the ground, then spirals straight up. Those differences are mostly visible to humans. To a pointing dog working ground scent in low cover, both birds are the same task. A dog bred to find Eurasian Woodcocks in the French Bresse, dropped into an eastern deciduous forest during spring migration, responds to American Woodcocks the same way.

<figure class="note-media">
  <img
    src="/images/notes/rare-dog-saint-usuge/woodcock-foraging.jpg"
    alt="American Woodcock with bill pointed down into the leaf litter, cryptic brown plumage blending with the ivy and fallen leaves around it."
  />
  <figcaption>American Woodcock foraging in Bryant Park, March 2026. Bill down in the leaf litter, eye visible. The exact posture a pointing spaniel was bred to find.</figcaption>
</figure>

I wrote about [American Woodcocks on this site](/notes/woodcocks-bryant-park/) a few weeks ago. When they showed up in Bryant Park this spring and drew hundreds of people to a single bird walk, I went. I stood among the smartphones. I watched a bird the size of a softball walk out of the azaleas and rock its whole weight back and forth as if dancing to music nobody else could hear. I wrote the piece. It's one of the most-read field notes on shellylynnx.com.
...
<figure class="note-media">
  <img
    src="/images/notes/rare-dog-saint-usuge/coral-bryant-park.jpg"
    alt="Coral, a chestnut-pied Épagneul de Saint-Usuge, alert and seated on a leash with my sister Vicki standing beside her in Bryant Park."
  />
  <figcaption>Coral in Bryant Park with my sister Vicki, the same park the woodcocks pass through every spring.</figcaption>
</figure>
...
I built [**NYC Off-Leash**](https://shellylynnx.github.io/projects/NYCoffleash/) because of the tension this piece is describing. It's a map of the city's dog runs and off-leash-permitted spaces, with a way to report maintenance issues and wildlife incidents. The design choice was to lead with what dog owners actually need, not with where dogs are banned.
