...
references:
  - number: 1
    ...
    url: "https://dashboard.birdcast.info/region/US-NY"
    note: "5,246,700 birds crossed the state that night; the prior night totaled about 16,900"
  - number: 2
    author: "Phil Jeffrey"
    title: "Central Park Birding: Birds by Season"
    url: "http://www.philjeffrey.net/cpb_bySeason.html"
    note: "Peak spring migration in Central Park runs from the last week of April through the first two weeks of May"
  - number: 3
    title: "Spring and Fall Migration in New York City"
    publication: "NYC Parks"
    url: "https://www.nycgovparks.org/learn/wildlife-in-new-york-city/spring-and-fall-migration"
  - number: 4
  ...
  - number: 5
    ...
    publication: "Carnegie Museum of Natural History"
    url: "https://carnegiemnh.org/wind-and-migration/"
  - number: 6
    title: "Bird fallout"
    publication: "Wikipedia"
    url: "https://en.wikipedia.org/wiki/Bird_fallout"
  - number: 7
  ...
  - number: 8
    ...
    date: "2020"
    url: "https://www.nature.com/articles/s41558-019-0648-9"
  - number: 9
    author: "Mayor, S.J., et al."
    title: "Increasing phenological asynchrony between spring green-up and arrival of migratory birds"
    publication: "Scientific Reports"
    date: "2017"
    url: "https://www.nature.com/articles/s41598-017-02045-z"
  - number: 10
    author: "Both, C., et al."
    title: "Climate warming, ecological mismatch at arrival and population decline in migratory birds"
    publication: "Proceedings of the Royal Society B"
    date: "2010"
    url: "https://pubmed.ncbi.nlm.nih.gov/20861045/"
  - number: 11
    title: "A Matter of Timing: Can Birds Keep Up With Earlier and Earlier Springs?"
    publication: "Audubon Magazine"
    url: "https://www.audubon.org/magazine/matter-timing-can-birds-keep-earlier-and-earlier-springs"
  - number: 12
    title: "BirdCast Live Migration Maps"
    publication: "Cornell Lab of Ornithology"
    url: "https://birdcast.info/live-migration-maps/"
  - number: 13
    title: "BirdCast Migration Forecast Maps"
    publication: "Cornell Lab of Ornithology"
    url: "https://birdcast.info/migration-tools/migration-forecast-maps/"
  - number: 14
    title: "30 Mnemonics to Help You Remember Bird Calls"
    publication: "Cornell Lab of Ornithology"
    url: "https://www.allaboutbirds.org/news/30-mnemonics-help-remember-bird-calls"
  - number: 15
    title: "How Climate Change Is Rewriting the Journeys of Migratory Birds"
...
<figure>
  ...
  <figcaption>Palm Warbler, one of the first warblers through NYC each spring. Photo © Shelly Xiong.</figcaption>
</figure>
...
[BirdCast](https://birdcast.info/) is non-negotiable right now. It's a free resource from the [Cornell Lab of Ornithology](https://www.birds.cornell.edu/home/) that bundles two separate tools: a live dashboard that summarizes last night's observed nocturnal migration off weather radar, and a forecast map that predicts tonight's expected movement (12, 13). Check the live dashboard each morning to see how heavy last night's flight was over New York, and the forecast each evening to plan tomorrow. It's the difference between going to the park with hope and going with knowledge.

[eBird's explore tools](https://ebird.org/explore) show you which species birders in your region are reporting in real time. This crowd-sourced data is powerful. If people are posting Black-throated Blue Warblers in Central Park, those birds exist there right now. Go look for them.
