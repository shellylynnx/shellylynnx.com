---
title: "Celebrity Birds: The Bryant Park Woodcocks"
description: "The American Woodcocks that took over Bryant Park this spring, the sound everyone got wrong, and the window-strike story TikTok didn't cover."
pubDate: 2026-04-20
author: "Shelly Xiong"
category: "Celebrity Birds"
tags:
  - woodcocks
  - bryant park
  - nyc
...
subwayRoutes:
  - hotspot: "Bryant Park"
    lines: ["B", "D", "F", "M", "7"]
    directions: "B, D, F, or M to 42 St-Bryant Park puts you directly under the park's southwest corner. 7 to 5 Av is at the east end. From Times Sq-42 St or Grand Central-42 St, walk two or three blocks. The B is weekday-only; D, F, M, and 7 run all day."
  - hotspot: "Wild Bird Fund, 565 Columbus Avenue"
    lines: ["1", "B", "C"]
    directions: "1 to 86 St, then one block east on 86th to Columbus. Or B or C to 86 St (Central Park West), then one block west. The clinic sits between 87th and 88th. Call ahead if you're bringing in an injured bird."
  - hotspot: "Floyd Bennett Field (woodcock display grounds)"
    lines: ["2"]
    buses: ["Q35"]
    directions: "2 train to Flatbush Av-Brooklyn College, then Q35 south toward Rockaway Park. Get off just before the Marine Parkway Bridge at the Floyd Bennett Field entrance on Flatbush Ave. Plan on about an hour from Midtown."
  - hotspot: "Jamaica Bay Wildlife Refuge (woodcock display grounds)"
    lines: ["A"]
...
references:
  - number: 1
    ...
    url: "https://gothamist.com/news/rock-it-like-a-woodcock-this-bryant-park-bogsucker-is-nycs-latest-it-bird"
  - number: 2
    title: "Migrating bird earns massive crowd in New York City's Bryant Park"
    publication: "The Cool Down"
    url: "https://thecooldown.com/outdoors/american-woodcock-bryant-park-nyc-sighting"
  - number: 3
    title: "Woodcocks draw a crowd in New York City's Bryant Park"
    publication: "95.5 WSB"
    url: "https://wsbradio.com/news/weird-news/new-yorkers-flock/IO26GI7KJI43TBMEVZNWH7ERKY"
  - number: 4
    title: "All About Birds: American Woodcock"
    publication: "Cornell Lab of Ornithology"
    url: "https://www.allaboutbirds.org/guide/American_Woodcock"
  - number: 5
    title: "These Rotund and 'Charmingly Goofy' Birds Are Delighting New Yorkers and Dancing on Social Media"
    publication: "Smithsonian Magazine"
    url: "https://www.smithsonianmag.com/smart-news/these-rotund-and-charmingly-goofy-birds-are-delighting-new-yorkers-and-dancing-on-social-media-what-is-the-american-woodcock-180988486"
  - number: 6
    title: "NYC's newest celebrity: The rare American woodcock dancing in Bryant Park"
    publication: "NBC New York"
    url: "https://www.nbcnewyork.com/manhattan/nyc-american-woodcock-dancing-bryant-park/6485603"
  - number: 7
    title: "New Yorkers Are Flocking To The Park For These Birds And Their Viral Strut"
    publication: "HuffPost"
    url: "https://www.huffpost.com/entry/viral-american-woodcock-bobbing-strut-new-york-city_n_69d7f0dce4b0ccb589ebaf4e"
  - number: 8
    title: "The viral dancing bird is back in Bryant Park"
    publication: "TimeOut NY"
    url: "https://www.timeout.com/newyork/news/the-viral-dancing-bird-is-back-in-bryant-park-040326"
  - number: 9
    title: "Viral Woodcock in Bryant Park Highlights a Serious Conservation Story Beneath the Dance Moves"
    publication: "Ruffed Grouse Society"
    url: "https://www.ruffedgrousesociety.org/viral-woodcock-in-bryant-park-highlights-a-serious-conservation-story-beneath-the-dance-moves"
  - number: 10
    title: "The Park"
    publication: "Bryant Park Corporation"
    url: "https://bryantpark.org/the-park"
  - number: 11
    title: "All About Birds: American Woodcock Sounds"
    publication: "Cornell Lab of Ornithology"
    url: "https://www.allaboutbirds.org/guide/American_Woodcock/sounds"
  - number: 12
    title: "Why the American Woodcock's Ears Are Below Its Big Eyes"
    publication: "Audubon"
    url: "https://www.audubon.org/news/why-american-woodcocks-ears-are-below-its-big-eyes"
  - number: 13
    title: "American Woodcock"
    publication: "Wild Bird Fund"
    url: "https://www.wildbirdfund.org/project/american-woodcock"
  - number: 14
    author: "Loss, S. R., Lao, S., Anderson, A. W., Blair, R. B., Eckles, J. W., & Turner, R. J."
    title: "Inclement weather and American woodcock building collisions during spring migration"
    publication: "Wildlife Biology"
    date: "2020"
    url: "https://bioone.org/journals/wildlife-biology/volume-2020/issue-1/wlb.00623"
  - number: 15
    title: "Project Safe Flight: Monitoring and Research"
    publication: "NYC Bird Alliance"
    url: "https://www.nycbirdalliance.org/our-work/conservation/project-safe-flight"
birdsMentioned:
...
More than six hundred and fifty people showed up for one of the park's woodcock-focused bird walks, according to the reporting. The naturalist leading it, Gabriel Willow, told reporters they'd needed "bird security" (3).

## Who they are

American Woodcocks (*Scolopax minor*) are shorebirds that don't act like shorebirds. They breed across the eastern U.S. and Canada, feed in forest floor leaf litter, and migrate at night, often over a hundred miles in a single stretch, from wintering grounds in the southern U.S. up to the Northeast and Upper Midwest (4).
...
The thing that made them go viral, the full-body bob-bob-bob, is a foraging behavior, not a mating display. Ornithologists think the vibration may cause earthworms in the soil to move, making them easier to detect; others think it's an anti-predator move (5). What's not up for debate is that it looks spectacular when set to the right music.

Bryant Park's own social team posted a clip of a woodcock set to the Black Eyed Peas' "Rock That Body," which somehow became the definitive version of this news cycle and was cited by half the coverage (1, 6). TimeOut NY, Gothamist, HuffPost, US News, NBC, The Mirror, Smithsonian Magazine. Everybody wrote about them (1, 6, 7, 8).
...
<figure class="note-media">
  ...
  >
    ...
    <img
      src="/images/notes/woodcocks-bryant-park/woodcock_bob.gif"
      alt="American Woodcock doing the characteristic slow rocking bob while foraging in leaf litter at Bryant Park."
    />
  </video>
  <figcaption>A Bryant Park woodcock mid-bob, March 17, 2026. The clip is muted and loops — no click required.</figcaption>
</figure>

## The sound most people get wrong

If you've watched the Bryant Park clips, you've probably seen captions guessing at the call: "meep," "squeak," "chirp." Those are close, but none of them are the word. The word is *peent* (11).
...
While not endangered, American Woodcock populations have declined significantly over the last several decades. Habitat loss, mostly (9). The Ruffed Grouse Society, which does habitat work for woodcocks and grouse, put out a piece pointing out that the Bryant Park viral moment is an accidental conservation opportunity (9). More people learned what a woodcock was in three weeks than in the previous decade.
...
Wild Bird Fund treats more than seven thousand birds a year, and window strikes are the leading cause of injury across all species they see (13). NYC Bird Alliance runs Project Safe Flight, the volunteer program that documents collisions block by block across Manhattan through both migration seasons; their data was central to the advocacy that produced Local Law 15 of 2020, the bird-safe glass rule for new construction in the city (15).
...
In spring, I go to Bryant Park. I find a chair. I wait. The timberdoodle either shows up or doesn't. Both are fine. The bird doesn't owe any of us anything and it's somehow still the most charming fifteen seconds of your day.
