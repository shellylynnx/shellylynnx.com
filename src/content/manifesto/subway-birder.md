---
title: "What Is a Subway Birder?"
description: "You don't need a car or a weekend getaway to bird New York City. You need a MetroCard, binoculars, and the willingness to stand still in a public park."
pubDate: 2026-04-22
draft: false
topics:
  - NYC birding
...
ogImageAlt: "Northern Mockingbird perched on a bare branch in New York City, gray-and-white plumage, long tail, alert posture. Photographed by Shelly Xiong."
...
New York City sits on the [Atlantic Flyway](https://abcbirds.org/program/migratory-birds/flyways/), one of the four major migration corridors in North America. [Over 400 species of birds](https://www.nycbirdalliance.org/new-to-birding/birding-in-new-york-city) have been recorded here. [Central Park alone has recorded more than 280](https://www.nycbirdalliance.org/our-work/advocacy/urban-habitat/central-park), which is more than many entire states. Olmsted didn't design Central Park for birds, but [the Ramble turned out to be one of the great urban migrant traps in North America anyway, and later advocacy formally protected it as a sanctuary](https://www.nycbirdalliance.org/our-work/advocacy/urban-habitat/central-park/protecting-the-ramble). Prospect Park was built with similar woodland intent. The city's green spaces are not accidents.

The bird life here is not accidentally here either. It is here because habitat, however fragmented, was preserved, rebuilt, and in some cases engineered. [Jamaica Bay Wildlife Refuge exists because of a long political fight](https://www.nps.gov/gate/learn/nature/jamaica-bay-wildlife-refuge.htm). [The Javits Center got bird-friendly glass (and a green roof that became bird habitat)](https://www.nycbirdalliance.org/our-work/advocacy/bird-friendly-buildings/javits-center) because of bird advocacy. [Lights Out New York](https://www.nycbirdalliance.org/our-work/conservation/lights-out-new-york) happens because people organized. To bird this city is to bird a place that has been fought for, and to recognize the people (mostly women, mostly volunteers, mostly unheralded) who did the fighting.
...
This is a boundary, and it is not one everybody in NYC agrees on. Playback (using a phone speaker to mimic a species' call) is common, easy, and often defended as "just a peek." I don't defend it. I think it's the simplest ethical test a birder fails or passes in the field, and [I have written about why elsewhere on this site](/notes/owl-speaker-code/).

The practice is a positive one, not only a negative. The Subway Birder ethic is: work with what the city gives you. If you wait in the Ramble long enough on a May morning, the warblers will arrive. If you walk the Bryant Park lawn in November, [the woodcocks will eventually come out of the azaleas on their own](/notes/woodcocks-bryant-park/). You don't have to hurry a bird into your binoculars. The birds have been here longer than any of us. They come to us when they come.
...
- **R** to Green-Wood Cemetery → hawks on the obelisks, warblers in the sycamores, and [the Monk Parakeet colony at the Gothic gate](https://www.nycbirdalliance.org/our-work/advocacy/urban-habitat/green-wood-cemetery) most Brooklynites walk past without knowing.
